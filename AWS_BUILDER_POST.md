# Agents for Humans: Building Grant Guardian – A Safety-First Autonomous Research Integrity Agent on AWS Bedrock & Strands

**Author**: Elena Rossi & The Grant Guardian Team  
**Category**: Artificial Intelligence / AWS Bedrock / Python Strands SDK / AWS AgentCore  
**Published On**: AWS Community Builders (builder.aws.com)  
**Tags**: Agents for Humans, Amazon Bedrock, Strands Agents, AWS AgentCore, AI Agents  
